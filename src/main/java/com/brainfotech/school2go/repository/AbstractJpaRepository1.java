 ...
 */
@Repository
public  class AbstractJpaRepository1<T extends AbstractIdEntity, ID extends Serializable> implements PagingAndSortingRepository<T, ID> {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractJpaRepository1.class);
